...
% IIf_st
 dy(7)  =  +  kon_iif/nbs_ii * L_TF * IIf  -  koff_iif * IIf_st  +  kc_s_iixavh * II_stbXa_stbVh_st  +  kc_s_iixava * II_stbXa_stbVa_st;

% IIf_s
 dy(8)  =  +  kon_iif/nbs_ii * L_noTF * IIf  -  koff_iif * IIf_s  +  kc_s_iixavh * II_sbXa_sbVh_s  +  kc_s_iixava * II_sbXa_sbVa_s;
...
% V_st
 dy(10)  =  +  kon_v/nbs_v * L_TF * V  -  koff_v * V_st  -  ka_s_xa_v * V_st * Xa_st  +  kd_s_xav * Xa_stbV_st  -  ka_on_s_iia_v * V_st * IIa  +  kd_off_s_iiav * IIabV_st;

% V_s
 dy(11)  =  +  kon_v/nbs_v * L_noTF * V  -  koff_v * V_s  -  ka_s_xa_v * V_s * Xa_s  +  kd_s_xav * Xa_sbV_s  -  ka_on_s_iia_v * V_s * IIa  +  kd_off_s_iiav * IIabV_s;
...
% Vh_st
 dy(13)  =  +  kon_vh/nbs_v * L_TF * Vh  -  koff_vh * Vh_st  +  kc_s_xav * Xa_stbV_st  -  ka_s_xa_vh * Vh_st * Xa_st  +  kd_s_xavh * Xa_stbVh_st  -  ka_on_s_iia_vh * Vh_st * IIa  +  kd_off_s_iiavh * IIabVh_st  -  ka_on_s_tfpi_vh * Vh_st * TFPI  +  kd_off_s_tfpivh * TFPIbVh_st  -  ka_on_s_tfpixa_vh * Vh_st * XabTFPI  +  kd_off_s_tfpixavh * Vh_stbTFPIbXa  -  ka_s_tfpixa_vh * Vh_st * Xa_stbTFPI  +  kd_s_tfpixavh * Vh_stbTFPIbXa_st;

% Vh_s
 dy(14)  =  +  kon_vh/nbs_v * L_noTF * Vh  -  koff_vh * Vh_s  +  kc_xav * Xa_sbV_s  -  ka_s_xa_vh * Vh_s * Xa_s  +  kd_s_xavh * Xa_sbVh_s  -  ka_on_s_iia_vh * Vh_s * IIa  +  kd_off_s_iiavh * IIabVh_s  -  ka_on_s_tfpi_vh * Vh_s * TFPI  +  kd_off_s_tfpivh * TFPIbVh_s  -  ka_on_s_tfpixa_vh * Vh_s * XabTFPI  +  kd_off_s_tfpixavh * Vh_sbTFPIbXa  -  ka_s_tfpixa_vh * Vh_s * Xa_sbTFPI  +  kd_s_tfpixavh * Vh_sbTFPIbXa_s;

% Va
 dy(15)  =  -  kon_va/nbs_v * L_TF * Va  +  koff_va * Va_st  -  kon_va/nbs_v * L_noTF * Va  +  koff_va * Va_s  +  kc_iiav * IIabV  +  kc_iiavh * IIabVh;

% Va_st
 dy(16)  =  +  kon_va/nbs_v * L_TF * Va  -  koff_va * Va_st  +  kc_s_iiav * IIabV_st  +  kc_s_iiavh * IIabVh_st  -  ka_s_xa_va * Va_st * Xa_st  +  kd_s_xava * Xa_stbVa_st;

% Va_s
 dy(17)  =  +  kon_va/nbs_v * L_noTF * Va  -  koff_va * Va_s  +  kc_s_iiav * IIabV_s  +  kc_s_iiavh * IIabVh_s  -  ka_s_xa_va * Va_s * Xa_s  +  kd_s_xava * Xa_sbVa_s;
...
% VII_st
 dy(19)  =  +  kon_vii/nbs_vii * L_TF * VII  -  koff_vii * VII_st  -  ka_s_tf_vii * VII_st * TF  +  kd_s_tfvii * TFbVII_st  -  ka_s_xa_vii * VII_st * Xa_st  +  kd_s_xavii * Xa_stbVII_st;

% VII_s
 dy(20)  =  +  kon_vii/nbs_vii * L_noTF * VII  -  koff_vii * VII_s  -  ka_s_xa_vii * VII_s * Xa_s  +  kd_s_xavii * Xa_sbVII_s;

% VIIa
 dy(21)  =  -  kon_viia/nbs_vii * L_TF * VIIa  +  koff_viia * VIIa_st  -  kon_viia/nbs_vii * L_noTF * VIIa  +  koff_viia * VIIa_s  +  kc_xavii * XabVII;

% VIIa_st
 dy(22)  =  +  kon_viia/nbs_vii * L_TF * VIIa  -  koff_viia * VIIa_st  -  ka_s_tf_viia * VIIa_st * TF  +  kd_s_tfviia * TFbVIIa_st  +  kc_s_xavii * Xa_stbVII_st;

% VIIa_s
 dy(23)  =  +  kon_viia/nbs_vii * L_noTF * VIIa  -  koff_viia * VIIa_s  +  kc_xaviii * Xa_sbVII_s;
...
% VIII_st
 dy(25)  =  +  kon_viii/nbs_viii * L_TF * VIII  -  koff_viii * VIII_st  -  ka_s_xa_viii * VIII_st * Xa_st  +  kd_s_xaviii * Xa_stbVIII_st  -  ka_on_s_iia_viii * VIII_st * IIa  +  kd_off_s_iiaviii * IIabVIII_st;

% VIII_s
 dy(26)  =  +  kon_viii/nbs_viii * L_noTF * VIII  -  koff_viii * VIII_s  -  ka_s_xa_viii * VIII_s * Xa_s  +  kd_s_xaviii * Xa_sbVIII_s  -  ka_on_s_iia_viii * VIII_s * IIa  +  kd_off_s_iiaviii * IIabVIII_s;
...
% VIIIa_st
 dy(28)  =  +  kon_viiia/nbs_viii * L_TF * VIIIa  -  koff_viiia * VIIIa_st  +  kc_s_xaviii * Xa_stbVIII_st  -  ka_s_viiia_ixa * VIIIa_st * IXa_st  +  kd_s_viiiaixa * VIIIa_stbIXa_st  +  kc_s_iiaviii * IIabVIII_st;

% VIIIa_s
 dy(29)  =  +  kon_viiia/nbs_viii * L_noTF * VIIIa  -  koff_viiia * VIIIa_s  +  kc_xaviii * Xa_sbVIII_s  -  ka_s_viiia_ixa * VIIIa_s * IXa_s  +  kd_s_viiiaixa * VIIIa_sbIXa_s  +  kc_s_iiaviii * IIabVIII_s;
...
% IX_st
 dy(31)  =  +  kon_ix/nbs_ix * L_TF * IX  -  koff_ix * IX_st  -  ka_s_ix_tfviia * IX_st * TFbVIIa_st  +  kd_s_ixtfviia * IX_stbTFbVIIa_st  -  ka_on_s_xia_ix * IX_st * XIa  +  kd_off_s_xiaix * XIabIX_st;

% IX_s
 dy(32)  =  +  kon_ix/nbs_ix * L_noTF * IX  -  koff_ix * IX_s  -  ka_on_s_xia_ix * IX_s * XIa  +  kd_off_s_xiaix * XIabIX_s  -  ka_s_pka_ix * IX_s * PKa  +  kd_s_pkaix * PKabIX_s;
...
% IXa_st
 dy(34)  =  +  kon_ixa/nbs_ixa * L_TF * IXa  -  koff_ixa * IXa_st  +  kc_s_ixtfviia * IX_stbTFbVIIa_st  -  ka_s_viiia_ixa * VIIIa_st * IXa_st  +  kd_s_viiiaixa * VIIIa_stbIXa_st  +  kc_s_xiaix * XIabIX_st  -  ka_s_ixa_x * IXa_st * X_st  +  kd_s_ixax * IXa_stbX_st  +  kc_ixax * IXa_stbX_st  -  ka_on_s_ixa_at * IXa_st * AT  +  kd_off_s_ixaat * IXa_stbAT;

% IXa_s
 dy(35)  =  +  kon_ixa/nbs_ixa * L_noTF * IXa  -  koff_ixa * IXa_s  -  ka_s_viiia_ixa * VIIIa_s * IXa_s  +  kd_s_viiiaixa * VIIIa_sbIXa_s  +  kc_s_xiaix * XIabIX_s  -  ka_s_ixa_x * IXa_s * X_s  +  kd_s_ixax * IXa_sbX_s  +  kc_s_ixax * IXa_sbX_s  -  ka_on_s_ixa_at * IXa_s * AT  +  kd_off_s_ixaat * IXa_sbAT  +  kc_s_pkaix * PKabIX_s;

% X
 dy(36)  =  -  kon_x/nbs_x * L_TF * X  +  koff_x * X_st  -  kon_x/nbs_x * L_noTF * X  +  koff_x * X_s  -  ka_ixa_x * IXa * X  +  kd_ixax * IXabX;

% X_st
 dy(37)  =  +  kon_x/nbs_x * L_TF * X  -  koff_x * X_st  -  ka_s_x_tfviia * X_st * TFbVIIa_st  +  kd_s_xtfviia * TFbVIIa_stbX_st  -  ka_s_x_viiiaixa * X_st * VIIIa_stbIXa_st  +  kd_s_xviiiaixa * X_stbVIIIa_stbIXa_st  -  ka_s_ixa_x * IXa_st * X_st  +  kd_s_ixax * IXa_stbX_st;

% X_s
 dy(38)  =  +  kon_x/nbs_x * L_noTF * X  -  koff_x * X_s  -  ka_s_x_viiiaixa * X_s * VIIIa_sbIXa_s  +  kd_s_xviiiaixa * X_sbVIIIa_sbIXa_s  -  ka_s_ixa_x * IXa_s * X_s  +  kd_s_ixax * IXa_sbX_s;
...
% Xa_stbTFPI
 dy(43)  =  +  kon_tfpixa/nbs_tfpixa * L_TF * XabTFPI  -  koff_tfpixa * Xa_stbTFPI  +  ka_on_s_tfpi_xa * Xa_st * TFPI  -  kd_off_s_tfpixa * Xa_stbTFPI  -  ka_s_tfpixa_tfviia * Xa_stbTFPI * TFbVIIa_st  +  kd_s_tfviiaxatfpi * TFbVIIa_stbXa_stbTFPI  -  ka_s_tfpixa_vh * Vh_st * Xa_stbTFPI  +  kd_s_tfpixavh * Vh_stbTFPIbXa_st;

% Xa_sbTFPI
 dy(44)  =  +  kon_tfpixa/nbs_tfpixa * L_noTF * XabTFPI  -  koff_tfpixa * Xa_sbTFPI  +  ka_on_s_tfpi_xa * Xa_s * TFPI  -  kd_off_s_tfpixa * Xa_sbTFPI  -  ka_s_tfpixa_vh * Vh_s * Xa_sbTFPI  +  kd_s_tfpixavh * Vh_sbTFPIbXa_s;
...
% TFPIbVh_st
 dy(46)  =  +  kon_tfpivh/nbs_tfpivh * L_TF * TFPIbVh  -  koff_tfpivh * TFPIbVh_st  +  ka_on_s_tfpi_vh * Vh_st * TFPI  -  kd_off_s_tfpivh * TFPIbVh_st  -  ka_s_tfpivh_xa * Xa_st * TFPIbVh_st  +  kd_s_tfpivhxa * Vh_stbTFPIbXa_st;

% TFPIbVh_s
 dy(47)  =  +  kon_tfpivh/nbs_tfpivh * L_noTF * TFPIbVh  -  koff_tfpivh * TFPIbVh_s  +  ka_on_s_tfpi_vh * Vh_s * TFPI  -  kd_off_s_tfpivh * TFPIbVh_s  -  ka_s_tfpivh_xa * Xa_s * TFPIbVh_s  +  kd_s_tfpivhxa * Vh_sbTFPIbXa_s;
...
% IXa_sbAT
 dy(49)  =  +  kon_ixat/nbs_ixaAT * L_noTF * IXabAT  -  koff_ixat * IXa_sbAT  +  ka_on_s_ixa_at * IXa_s * AT  -  kd_off_s_ixaat * IXa_sbAT;

% IXa_stbAT
 dy(50)  =  +  kon_ixat/nbs_ixaAT * L_TF * IXabAT  -  koff_ixat * IXa_stbAT  +  ka_on_s_ixa_at * IXa_st * AT  -  kd_off_s_ixaat * IXa_stbAT;
...
% Xa_sbAT
 dy(52)  =  +  kon_xaat/nbs_xaAT * L_noTF * XabAT  -  koff_xaat * Xa_sbAT  +  ka_on_s_xa_at * Xa_s * AT  -  kd_off_s_xaat * Xa_sbAT;

% Xa_stbAT
 dy(53)  =  +  kon_xaat/nbs_xaAT * L_TF * XabAT  -  koff_xaat * Xa_stbAT  +  ka_on_s_xa_at * Xa_st * AT  -  kd_off_s_xaat * Xa_stbAT;

% PS
 dy(54)  =  -  kon_ps/nbs_PS * L_TF * PS  +  koff_ps * PS_st  -  kon_ps/nbs_PS * L_noTF * PS  +  koff_ps * PS_s;

% PS_st
 dy(55)  =  +  kon_ps/nbs_PS * L_TF * PS  -  koff_ps * PS_st;

% PS_s
 dy(56)  =  +  kon_ps/nbs_PS * L_noTF * PS  -  koff_ps * PS_s;
