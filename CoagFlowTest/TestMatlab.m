function [time,y] = CoagFlowTest/TestMatlab(t_start,t_final)
...
%     python createMatlabFile.py CoagFlowTest/Test.txt
%
...
% B
 dy(2)  =  -  d * B  -  2 * k_1 * A * B^2  -  k_6 * A * B  -  2 * k_1 * A * B^2  +  2 * k_2 * D;
